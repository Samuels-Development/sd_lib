...
local AddItem = function()
    -- Check for the selected inventory system
    if inventorySystem == 'codem' then
    ...
    elseif inventorySystem == 'tgiann' then
        ...
        elseif Framework == 'qb' then
            ...
            -- Handle unsupported frameworks or systems
            return function()
                error("Unsupported framework or inventory system state for AddItem.")
            end
        end
    end
end

-- Call the AddItem function to initialize it
...
-- Call the RemoveItem function to initialize it
